...
SET(STM32_CODES 2[01][57].[BCEGI])

MACRO(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](.....).+$" "\\1" STM32_CODE ${CHIP})
    SET(INDEX 0)
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE)
    ...
    ENDIF()
    SET_TARGET_PROPERTIES(${TARGET} PROPERTIES COMPILE_DEFINITIONS "STM32F2;STM32F${CHIP_TYPE};")
ENDFUNCTION()