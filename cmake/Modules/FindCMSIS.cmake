...
IF(STM32_FAMILY STREQUAL "F0")
    ...
    SET(CMSIS_HEADERS system_stm32f0xx.h core_cm0.h stm32f0xx.h)
    SET(CMSIS_LINKER_SCRIPT_NAME stm32f0_flash.ld.in)
...
ELSEIF(STM32_FAMILY STREQUAL "F2")
    SET(CMSIS_STARTUP_PREFIX startup_stm32f)
    SET(CMSIS_HEADERS system_stm32f2xx.h core_cm3.h stm32f2xx.h)
    SET(CMSIS_LINKER_SCRIPT_NAME stm32f2_flash.ld.in)
...
FIND_FILE(CMSIS_LINKER_SCRIPT
    ${CMSIS_LINKER_SCRIPT_NAME}
    PATHS ${CMAKE_FIND_ROOT_PATH}/share/cmsis/
)

MACRO(REBUILD_CMSIS_LIBRARY)
    STRING(TOLOWER "${STM32_CHIP_TYPE}" CHIP_TYPE_LOWER)
    SET(TARGET_NAME cmsis_${STM32_FAMILY_LOWER}_${CHIP_TYPE_LOWER}_custom)
    FIND_FILE(CMSIS_SOURCE_FILE
       ${CMSIS_SOURCES}
       PATHS ${CMAKE_FIND_ROOT_PATH}/share/cmsis/
    )
    ADD_LIBRARY(${TARGET_NAME} ${CMSIS_SOURCE_FILE})
    STM32_SET_CHIP_DEFINITIONS(${TARGET_NAME} ${STM32_CHIP_TYPE})
    SET(CMSIS_LIBRARIES ${TARGET_NAME})
ENDMACRO()
