...
SETUP_BUILD_TOOL(ASM_COMPILER as)
...
FUNCTION(STM32_SET_FLASH_PARAMS TARGET FLASH_SIZE RAM_SIZE)
    ...
    IF(NOT STM32_STACK_ADDRESS)
        CONVERT_TODEC(STM32_RAM_ORIGIN)
        CONVERT_TODEC(RAM_SIZE)
    ...
    CONVERT_TOHEX(STM32_RAM_ORIGIN)
    CONVERT_TOHEX(STM32_FLASH_ORIGIN)
    CONVERT_TOHEX(STM32_RAM_SIZE)
    CONVERT_TOHEX(STM32_FLASH_SIZE)
    CONVERT_TOHEX(STM32_STACK_ADDRESS)
    CONVERT_TOHEX(STM32_MIN_STACK_SIZE)
    CONVERT_TOHEX(STM32_MIN_HEAP_SIZE)
